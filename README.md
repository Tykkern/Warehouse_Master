...
### Пример файла warehouse.json для работоспособности приложения (Если его не будет создастся пустой автоматически)
```[
[
  {
    "type": "FoodProduct",
...
- **10 юнит-тестов** — проверяют отдельные методы классов `Warehouse`, `FoodProduct`, `ElectronicsProduct`
- **2 функциональных теста** — проверяют сквозные сценарии (полный цикл работы склада и сохранение/загрузку JSON)

## Использованные техники тестирования
- Equivalence partitioning
- Boundary value analysis (цена 0, срок годности = сегодня, гарантия 0, ID несуществующий и т.д.)
- Positive / negative testing
- Поиск: точное, частичное, регистронезависимое совпадение

## Результаты запуска тестов

Все 12 тестов **прошли успешно** (100% coverage ключевой логики).

## **Скриншоты:**
Скриншот 1: результат выполнения JUnit тестов в IntelliJ IDEA
- ![img_1.png](img_1.png)

Gradle test report
- ![img_2.png](img_2.png)

Отчет сформированный Gradle'ом
- ![img_3.png](img_3.png)
